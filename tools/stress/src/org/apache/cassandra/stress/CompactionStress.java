...
public abstract class CompactionStress implements Runnable
{
    ...
    TableStore initCf(StressProfile stressProfile, boolean loadSSTables)
    {
        ...
        TableStore cfs = StressCQLSSTableWriter.Builder.createOfflineTable(createStatement, Collections.EMPTY_LIST, dataDirectories);
    ...
    public static class Compaction extends CompactionStress
    {
        ...
        public void run()
        {
            ...
            TableStore cfs = initCf(stressProfile, true);
    ...
    public static class DataWriter extends CompactionStress
    {
        ...
        {
            StressProfile stressProfile = getStressProfile();
            TableStore cfs = initCf(stressProfile, false);
