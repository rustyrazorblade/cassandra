...
public class StreamingTransferTest
{
     ...
     */
    private List<String> createAndTransfer(Table cfs, Mutator mutator, boolean transferSSTables) throws Exception
    {
    ...
    private void transferRanges(Table cfs) throws Exception
    {
    ...
    private void doTransferTable(boolean transferSSTables) throws Exception
    {
        ...
        final Table cfs = keyspace.getColumnFamilyStore(CF_INDEX);
    ...
    {
        final Keyspace keyspace = Keyspace.open(KEYSPACE1);
        final Table cfs = keyspace.getColumnFamilyStore("Counter1");
    ...
    public void testTransferTableMultiple() throws Exception
    {
        ...
        Table cfstore = Keyspace.open(keyspaceName).getColumnFamilyStore(cfname);
    ...
    public void testTransferOfMultipleColumnFamilies() throws Exception
    {
        ...
        {
            Table store = Keyspace.open(keyspace).getColumnFamilyStore(entry.getValue());
    ...
    {
        final Keyspace keyspace = Keyspace.open(KEYSPACE1);
        final Table cfs = keyspace.getColumnFamilyStore("Standard1");
