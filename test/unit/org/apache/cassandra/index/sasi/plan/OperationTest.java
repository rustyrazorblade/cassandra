...
public class OperationTest extends SchemaLoader
{
    ...
    private static TableStore BACKEND;
    private static TableStore CLUSTERING_BACKEND;
    private static TableStore STATIC_BACKEND;
    ...
    private static ColumnMetadata getColumn(TableStore cfs, ByteBuffer name)
    {
