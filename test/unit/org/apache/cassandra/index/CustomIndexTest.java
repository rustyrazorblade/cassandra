...
public class CustomIndexTest extends CQLTester
{
    ...
    {
        public BrokenCustom2I(Table baseCfs, IndexMetadata metadata)
        {
    ...
    public static final class CountMetadataReloadsIndex extends StubIndex
    {
        ...
        public CountMetadataReloadsIndex(Table baseCfs, IndexMetadata metadata)
        {
            super(baseCfs, metadata);
        }
    ...
    {
        public IndexIncludedInBuild(Table baseCfs, IndexMetadata metadata)
        {
            super(baseCfs, metadata);
        }
    ...
    {
        public UTF8ExpressionIndex(Table baseCfs, IndexMetadata metadata)
        {
            super(baseCfs, metadata);
        }
    ...
    {
        public Int32ExpressionIndex(Table baseCfs, IndexMetadata metadata)
        {
            super(baseCfs, metadata);
        }
    ...
    public static final class SettableSelectivityIndex extends StubIndex
    {
        ...
        public SettableSelectivityIndex(Table baseCfs, IndexMetadata metadata)
        {
            super(baseCfs, metadata);
        }
    ...
    {
        public IndexExcludedFromBuild(Table baseCfs, IndexMetadata metadata)
        {
            super(baseCfs, metadata);
        }
    ...
    {
        public NoCustomExpressionsIndex(Table baseCfs, IndexMetadata metadata)
        {
            super(baseCfs, metadata);
        }
    ...
    {
        public AlwaysRejectIndex(Table baseCfs, IndexMetadata metadata)
        {
            super(baseCfs, metadata);
        }
    ...
    public static final class IndexWithValidateOptions extends StubIndex
    {
        ...
        public IndexWithValidateOptions(Table baseCfs, IndexMetadata metadata)
        {
            super(baseCfs, metadata);
        }
    ...
    public static final class IndexWithOverloadedValidateOptions extends StubIndex
    {
        ...
        public IndexWithOverloadedValidateOptions(Table baseCfs, IndexMetadata metadata)
        {
            super(baseCfs, metadata);
        }
    ...
    public static final class SimulateConcurrentFlushingIndex extends StubIndex
    {
        ...
        public SimulateConcurrentFlushingIndex(Table baseCfs, IndexMetadata metadata)
        {
            super(baseCfs, metadata);
