...
public class LogTransactionTest extends AbstractTransactionalTest
{
    ...
    private static final class TxnTest extends TestableTransaction
    {
        private final static class Transaction extends Transactional.AbstractTransactional implements Transactional
        {
            ...
            Transaction(TableStore cfs, LogTransaction txnLogs) throws IOException
            {
                this.cfs = cfs;
        ...
        private TxnTest(TableStore cfs) throws IOException
        {
            this(cfs, new LogTransaction(OperationType.COMPACTION));
        }

        private TxnTest(TableStore cfs, LogTransaction txnLogs) throws IOException
        {
    ...
    {
        TableStore cfs = MockSchema.newCFS(KEYSPACE);
    ...
    private static SSTableReader sstable(File dataFolder, TableStore cfs, int generation, int size) throws IOException
    {
