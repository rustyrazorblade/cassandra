 ...
 *
 * Two obligations. A writer whose network gives out has to throw. The caller aborts the transfer on that
 * exception. A silent failure would leave a session that never finishes. A reader handed truncated or corrupt
