...
/**
 * Differential scenarios inside the cursor read gate's supported surface: every test runs
...
public class BasicCursorReadDifferentialTest extends CursorReadDifferentialTester
{
    ...
    public void memtableAndSSTableMerge() throws Throwable
    {
        ...
        // The memtable leg stays on the object path; the sstable legs are cursor-served, and the
        // merge across them must be identical.
    ...
    public void absentPartition() throws Throwable
    {
        ...
        // scenario proves nothing, so skip instead of running it
