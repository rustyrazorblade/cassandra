 ...
 * sliced scenarios exercise the row-index seek (and its open-marker seed) under a merge that also
 * contains an unseeked, object-backed memtable leg: the mixed seeked/unseeked-leg case.
 */
