...
public class CompactionStrategyManagerTest
{
    ...
    public void testSSTablesAssignedToCorrectCompactionStrategy() throws IOException
    {
        ...
        TableStore cfs = Keyspace.open(KS_PREFIX).getColumnFamilyStore(TABLE_PREFIX);
    ...
    class MockBoundaryManager
    {
        ...
        public MockBoundaryManager(TableStore cfs, Integer[] positions)
        {
            this.cfs = cfs;
        ...
        private DiskBoundaries createDiskBoundaries(TableStore cfs, Integer[] boundaries)
        {
    ...
    private static class MockCFS extends TableStore
    {
        MockCFS(TableStore cfs, Directories dirs)
        {
