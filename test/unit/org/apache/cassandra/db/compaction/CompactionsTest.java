...
public class CompactionsTest
{
    ...
    public TableStore testSingleSSTableCompaction(String strategyClassName) throws Exception
    {
        Keyspace keyspace = Keyspace.open(KEYSPACE1);
        TableStore store = keyspace.getColumnFamilyStore(CF_DENSE1);
        store.clearUnsafe();
    ...
    {
        TableStore store = testSingleSSTableCompaction(LeveledCompactionStrategy.class.getCanonicalName());
    ...
    {
        Keyspace keyspace = Keyspace.open(KEYSPACE1);
        TableStore cfs = keyspace.getColumnFamilyStore("Super1");
    ...
    */
    ...
    public static void assertMaxTimestamp(TableStore cfs, long maxTimestampExpected)
    {
    ...
    public void testCompactionLog() throws Exception
    {
        ...
        String cf = "Standard4";
        TableStore cfs = Keyspace.open(KEYSPACE1).getColumnFamilyStore(cf);
