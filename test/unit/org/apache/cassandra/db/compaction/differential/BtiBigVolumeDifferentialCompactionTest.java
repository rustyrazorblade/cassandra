...
/** The two-million-row volume scenario with the BTI format selected. */
public class BtiBigVolumeDifferentialCompactionTest extends BigVolumeDifferentialCompactionTest
{
