...
/**
 * Increment 3: the FULL edge-case differential corpus with the BTI format selected — both
 * pipelines read and write BTI sstables, and the harness byte-compares every component
 * including the partition and row index tries (Partitions.db / Rows.db). Tries are
 * deterministic given identical inputs, so byte identity is the correct bar.
 */
