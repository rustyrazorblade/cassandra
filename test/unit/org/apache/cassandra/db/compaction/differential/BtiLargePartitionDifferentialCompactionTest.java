...
/** The giant-partition scenario with the BTI format selected (row trie at huge block counts). */
public class BtiLargePartitionDifferentialCompactionTest extends LargePartitionDifferentialCompactionTest
{
