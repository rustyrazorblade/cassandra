...
/**
 * The full cursor-cleanup differential corpus with the BTI format selected.  Cleanup rewrites one
 * sstable partially, so this covers the BTI partition and row index tries being rebuilt from a
 * truncated key set.
 */
