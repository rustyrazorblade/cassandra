...
public class CursorCompactorRegistrationLeakTest extends CQLTester
{
    ...
    public void constructorFailureAfterBeginCompactionUnregisters() throws Throwable
    {
        ...
        {
            // A range that ends before it starts makes the StatefulCursor constructor throw, from
            // the reader's first advanceSegment - inside convertSSTablesToPartialRangeCursors,
            // which runs AFTER the constructor's beginCompaction registration. This is exactly
            // the ctor-throws-after-register path. Two other candidates do not work here: an
            // empty bounds list reads nothing without complaint, and overlapping ranges are only
            // caught when the reader advances to the second one, which construction never does.
