...
public class KeyspaceTest extends CQLTester
{
    ...
    public void testGetRowNoColumns() throws Throwable
    {
        ...
        final Table cfs = getCurrentColumnFamilyStore();
    ...
    private static void assertRowsInSlice(Table cfs, String key, int sliceStart, int sliceEnd, int limit, boolean reversed, String columnValuePrefix)
    {
    ...
    private static void assertRowsInResult(Table cfs, SinglePartitionReadCommand command, int ... columnValues)
    {
        try (ReadExecutionController executionController = command.executionController();
             PartitionIterator iterator = command.executeInternal(executionController))
        {
    ...
    private static ClusteringIndexSliceFilter slices(Table cfs, Integer sliceStart, Integer sliceEnd, boolean reversed)
    {
    ...
    private static SinglePartitionReadCommand singlePartitionSlice(Table cfs, String key, ClusteringIndexSliceFilter filter, Integer rowLimit)
    {
    ...
    private void validateSliceLarge(Table cfs)
    {
