...
public class RowCacheTest
{
    ...
    public void testRoundTrip() throws Exception
    {
        ...
        TableStore cachedStore  = keyspace.getColumnFamilyStore(cf);
    ...
    public void testRowCache() throws Exception
    {
        ...
        Keyspace keyspace = Keyspace.open(KEYSPACE_CACHED);
        TableStore cachedStore  = keyspace.getColumnFamilyStore(CF_CACHED);
    ...
    public void testRowCacheNoClustering() throws Exception
    {
        ...
        Keyspace keyspace = Keyspace.open(KEYSPACE_CACHED);
        TableStore cachedStore  = keyspace.getColumnFamilyStore(CF_CACHEDNOCLUSTER);
    ...
    public void testRowCacheCleanup() throws Exception
    {
        ...
        TableStore store = Keyspace.open(KEYSPACE_CACHED).getColumnFamilyStore(CF_CACHED);
