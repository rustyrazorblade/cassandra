...
/**
 * the flush support matrix with the BTI format selected.  BTI is the priority format for the cursor work, so the
 * cursor flush path must produce byte-identical BTI sstables, not only the default format.
 */
public class BtiMemtableFlushSupportMatrixTest extends MemtableFlushSupportMatrixTest
{
