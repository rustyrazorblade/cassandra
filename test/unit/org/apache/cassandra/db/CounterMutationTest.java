...
public class CounterMutationTest
{
    ...
    {
        TableStore cfs = Keyspace.open(KEYSPACE1).getColumnFamilyStore(CF1);
    ...
    private void addAndCheck(TableStore cfs, long toAdd, long expected)
    {
        ColumnMetadata cDef = cfs.metadata().getColumn(ByteBufferUtil.bytes("val"));
    ...
    private void addTwoAndCheck(TableStore cfs, long addOne, long expectedOne, long addTwo, long expectedTwo)
    {
    ...
    {
        TableStore cfsOne = Keyspace.open(KEYSPACE1).getColumnFamilyStore(CF1);
        TableStore cfsTwo = Keyspace.open(KEYSPACE1).getColumnFamilyStore(CF2);
