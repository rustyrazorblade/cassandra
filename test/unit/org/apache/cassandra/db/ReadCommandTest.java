...
public class ReadCommandTest
{
    ...
    {
        TableStore cfs = Keyspace.open(KEYSPACE).getColumnFamilyStore(CF1);
    ...
    {
        TableStore cfs = Keyspace.open(KEYSPACE).getColumnFamilyStore(CF2);
    ...
    {
        TableStore cfs = Keyspace.open(KEYSPACE).getColumnFamilyStore(CF3);
    ...
    {
        TableStore cfs = Keyspace.open(KEYSPACE).getColumnFamilyStore(CF4);
    ...
    {
        TableStore cfs = Keyspace.open(KEYSPACE).getColumnFamilyStore(CF5);
