...
public class AlterTest extends CQLTester
{
    ...
    public void testCreateAlterNetworkTopologyWithDefaults() throws Throwable
    {
        ...
        String ks1 = createKeyspace("CREATE KEYSPACE %s WITH replication={ 'class' : 'NetworkTopologyStrategy', 'default_datacenter_replication' : 1, '" + DATA_CENTER_REMOTE + "': 3}");
        ...
        schemaChange("ALTER KEYSPACE " + ks1 + " WITH replication = { 'class' : 'NetworkTopologyStrategy', 'default_datacenter_replication' : 1 } AND durable_writes=True");
