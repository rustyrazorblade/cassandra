...
public abstract class CQLTester
{
    ...
    public TableStore getCurrentColumnFamilyStore(String keyspace)
    {
    ...
    {
        TableStore store = getCurrentColumnFamilyStore(keyspace);
        if (store != null)
    ...
    public void compact()
    {
        try
        {
            TableStore store = getCurrentColumnFamilyStore();
            if (store != null)
