...
public class LegacySSTableTest
{
    ...
    public void testMutateMetadata() throws Exception
    {
        ...
        for (String legacyVersion : legacyVersions)
        {
            ...
            for (Table cfs : Keyspace.open("legacy_tables").getColumnFamilyStores())
            {
    ...
    public void testVerifyOldSSTables() throws IOException
    {
        for (String legacyVersion : legacyVersions)
        {
            Table cfs = Keyspace.open("legacy_tables").getColumnFamilyStore(String.format("legacy_%s_simple", legacyVersion));
    ...
    private static void loadLegacyTable(String tablePattern, String legacyVersion) throws IOException
    {
        ...
        Table cfs = Keyspace.open("legacy_tables").getColumnFamilyStore(table);
