...
public class SSTableWriterTestBase extends SchemaLoader
{
    ...
    public static void truncate(Table cfs)
    {
     ...
     */
    public static void validateCFS(Table cfs)
    {
    ...
    public static SSTableWriter getWriter(Table cfs, File directory, LifecycleTransaction txn)
    {
