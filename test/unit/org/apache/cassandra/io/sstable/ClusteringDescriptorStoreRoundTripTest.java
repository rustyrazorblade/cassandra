...
/**
 * Checks that {@link UnfilteredDescriptor#storeRowClustering} and
 * {@link UnfilteredDescriptor#storeMarker} serialize a byte layout that
 * {@link ClusteringDescriptor#toClusteringPrefix} reads back losslessly, in isolation from a full
 * memtable flush.
 */
public class ClusteringDescriptorStoreRoundTripTest
{
    ...
    public void rowClusteringRoundTripsMultiColumn()
    {
        ...
        assertPrefixEquals(clustering, descriptor.toClusteringPrefix(TYPES));
    }
    ...
    public void inclStartBoundRoundTrips()
    {
        ...
        assertPrefixEquals(bound, descriptor.toClusteringPrefix(TYPES));
    ...
    public void boundaryRoundTripsBothDeletionTimes()
    {
        ...
        assertPrefixEquals(boundary, descriptor.toClusteringPrefix(TYPES));
    ...
    {
        // storeMarker must honor the passed-in kind, not valuesSource.kind(): the marker adapter
        // reuses one bound as the values source for a merged boundary and passes the kind
        // separately.
        UnfilteredDescriptor descriptor = new UnfilteredDescriptor(TYPES);
        ...
        ClusteringPrefix<?> decoded = descriptor.toClusteringPrefix(TYPES);
    ...
    public void repeatedStoresReuseScratchCorrectly()
    {
        ...
        assertPrefixEquals(shorter, descriptor.toClusteringPrefix(TYPES));
    }
}
