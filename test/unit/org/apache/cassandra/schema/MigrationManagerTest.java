...
public class MigrationManagerTest
{
    ...
    public void addNewTable() throws ConfigurationException
    {
        ...
        TableStore cfs = Keyspace.open(ksName).getColumnFamilyStore(tableName);
        assertNotNull(cfs);
    ...
    public void dropCf() throws ConfigurationException
    {
        ...
        TableStore store = Keyspace.open(cfm.keyspace).getColumnFamilyStore(cfm.name);
        assertNotNull(store);
    ...
    public void dropKS() throws ConfigurationException
    {
        ...
        TableStore cfs = Keyspace.open(cfm.keyspace).getColumnFamilyStore(cfm.name);
        assertNotNull(cfs);
        cfs.forceBlockingFlush();
    ...
    public void createEmptyKsAddNewCf() throws ConfigurationException
    {
        ...
        TableStore cfs = Keyspace.open(newKs.name).getColumnFamilyStore(newCf.name);
        assertNotNull(cfs);
        cfs.forceBlockingFlush();
    ...
    */
    ...
    public void testDropIndex() throws ConfigurationException
    {
        ...
        TableStore cfs = Keyspace.open(KEYSPACE6).getColumnFamilyStore(TABLE1i);
        ...
        cfs.forceBlockingFlush();
        TableStore indexCfs = cfs.indexManager.getIndexByName(indexName)
                                              .getBackingTable()
