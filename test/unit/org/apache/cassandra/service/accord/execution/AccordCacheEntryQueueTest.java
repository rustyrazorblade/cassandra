 ...
 * The four properties the queue maintains are stated explicitly after every mutation, rather than relying on the
 * class's own paranoid-mode assertions:
 *
 * <ul>
 *   <li><b>Q1</b> the sorted prefix is sorted by {@link AccordCacheEntryQueue#compare};</li>
 *   <li><b>Q2</b> every bag member sorts after every member of the sorted prefix, which is what lets an arrival that
 *       sorts past the prefix be bagged in O(1) (maintained by
 *       {@link AccordCacheEntryQueue#extendPriorityRegion});</li>
