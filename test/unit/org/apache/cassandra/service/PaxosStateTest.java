...
public class PaxosStateTest
{
    ...
    {
        Table cfs = Keyspace.open("PaxosStateTestKeyspace1").getColumnFamilyStore("Standard1");
    ...
    private void assertDataPresent(Table cfs, DecoratedKey key, String name, ByteBuffer value)
    {
    ...
    private void assertNoDataPresent(Table cfs, DecoratedKey key)
    {
