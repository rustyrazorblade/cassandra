 ...
 * table's TableStore and the IndexMetadata which defines the Index as arguments. e.g:
 *  {@code MyCustomIndex( TableStore baseCfs, IndexMetadata indexDef )}
 *
...
public interface Index
{
    ...
    {
        SecondaryIndexBuilder getIndexBuildTask(TableStore cfs, Set<Index> indexes, Collection<SSTableReader> sstables);
    }
     ...
     * returned by a call to the {@code}getIndex(TableStore cfs){@code} method on
