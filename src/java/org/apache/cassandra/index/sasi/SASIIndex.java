...
public class SASIIndex implements Index, INotificationConsumer
{
    ...
    {
        public SecondaryIndexBuilder getIndexBuildTask(TableStore cfs,
                                                       Set<Index> indexes,
    ...
    public SASIIndex(TableStore baseCfs, IndexMetadata config)
    {
    ...
    public Searcher searcherFor(ReadCommand command) throws InvalidRequestException
    {
        ...
        TableStore cfs = Schema.instance.getColumnFamilyStoreInstance(config.id);
