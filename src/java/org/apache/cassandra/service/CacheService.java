...
public class CacheService implements CacheServiceMBean
{
    ...
    {
        public void serialize(CounterCacheKey key, DataOutputPlus out, Table cfs) throws IOException
        {
        ...
        public Future<Pair<CounterCacheKey, ClockAndCount>> deserialize(DataInputPlus in, final Table cfs) throws IOException
        {
    ...
    {
        public void serialize(RowCacheKey key, DataOutputPlus out, Table cfs) throws IOException
        {
        ...
        public Future<Pair<RowCacheKey, IRowCacheEntry>> deserialize(DataInputPlus in, final Table cfs) throws IOException
        {
            //Keyspace and CF name are deserialized by AutoSaving cache and used to fetch the CFS provided as a
            //parameter so they aren't deserialized here, even though they are serialized by this serializer
    ...
    {
        public void serialize(KeyCacheKey key, DataOutputPlus out, Table cfs) throws IOException
        {
        ...
        public Future<Pair<KeyCacheKey, RowIndexEntry>> deserialize(DataInputPlus input, Table cfs) throws IOException
        {
            //Keyspace and CF name are deserialized by AutoSaving cache and used to fetch the CFS provided as a
            //parameter so they aren't deserialized here, even though they are serialized by this serializer
