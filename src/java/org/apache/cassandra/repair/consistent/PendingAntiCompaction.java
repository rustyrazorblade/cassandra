...
public class PendingAntiCompaction
{
    ...
    static class AcquireResult
    {
        ...
        AcquireResult(Table cfs, Refs<SSTableReader> refs, LifecycleTransaction txn)
        {
            this.cfs = cfs;
            this.refs = refs;
            this.txn = txn;
    ...
    static class AcquisitionCallable implements Callable<AcquireResult>
    {
        ...
        public AcquisitionCallable(Table cfs, Collection<Range<Token>> ranges, UUID sessionID)
        {
            this.cfs = cfs;
            this.ranges = ranges;
    ...
    public ListenableFuture run()
    {
        ...
        Collection<Table> cfss = prs.getColumnFamilyStores();
