        ...
        try
        {
            switch (message.payload.messageType)
            {
                case PREPARE_MESSAGE:
                    ...
                    List<TableStore> tableStores = new ArrayList<>(prepareMessage.tableIds.size());
                    for (TableId tableId : prepareMessage.tableIds)
                    {
                        TableStore tableStore = TableStore.getIfExists(tableId);
                        if (tableStore == null)
                        {
                ...
                case SNAPSHOT:
                    ...
                    final TableStore cfs = TableStore.getIfExists(desc.keyspace, desc.columnFamily);
                    if (cfs == null)
                    {
                ...
                case VALIDATION_REQUEST:
                    ...
                    TableStore store = TableStore.getIfExists(desc.keyspace, desc.columnFamily);
                    if (store == null)
                    {
