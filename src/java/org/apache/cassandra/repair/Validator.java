...
public class Validator implements Runnable
{
    ...
    /**
     * Cursor-backed counterpart to {@link #add}: takes a digest already computed from cursor
     * primitives (see {@code DigestingCursorMergeSink}) instead of an {@link UnfilteredRowIterator},
     * so the partition is never re-walked to recompute a digest already produced.
     *
