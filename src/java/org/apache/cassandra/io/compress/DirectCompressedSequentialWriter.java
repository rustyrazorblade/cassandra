...
public class DirectCompressedSequentialWriter extends CompressedSequentialWriter
{
    ...
    {
        super(file, offsetsFile, digestFile, option, parameters, sstableMetadataCollector, ExtendedOpenOption.DIRECT);
        ...
        protected Throwable doPreCleanup(Throwable accumulate)
        {
            if (writeBuffer != null)
            {
                try
                {
                    ...
                    FileUtils.clean((ByteBuffer) ((DirectBuffer) writeBuffer).attachment());
                }
                catch (Throwable t)
                {
