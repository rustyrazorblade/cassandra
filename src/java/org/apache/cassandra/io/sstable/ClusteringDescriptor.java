...
public class ClusteringDescriptor extends ResizableByteBuffer
{
    ...
    {
        set(ClusteringPrefix.Kind.ALL_KINDS[clusteringKind], clusteringKind, clusteringColumnsBound);
    ...
    private void set(byte clusteringKindEncoded, int clusteringColumnsBound) {
        set(ClusteringPrefix.Kind.ALL_KINDS[clusteringKindEncoded], clusteringKindEncoded, clusteringColumnsBound);
    }
