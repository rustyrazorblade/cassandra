...
public class SSTableCursorWriter implements AutoCloseable, CursorMergeSink
{
                                  ...
                                  int headerLength, ClusteringDescriptor lastName) throws IOException
    {
        ...
        //
        // Compaction only. flush never opens early: MemtableCursorFlusher.flush sets last once at the
        // end. Paying the per-partition copy on the flush path costs more than the cursor saves there.
        if (ownsUnderlyingWriter)
        {
