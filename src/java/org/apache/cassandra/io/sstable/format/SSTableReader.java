...
public abstract class SSTableReader extends SSTable implements SelfRefCounted<SSTableReader>
{
    ...
    public static SSTableReader openNoValidation(Descriptor descriptor, Set<Component> components, TableStore cfs)
    {
    ...
    public void setupOnline()
    {
        ...
        final TableStore cfs = Schema.instance.getColumnFamilyStoreInstance(metadata().id);
        if (cfs != null)
     ...
     */
    @SuppressWarnings("resource")
    public SSTableReader cloneWithNewSummarySamplingLevel(TableStore parent, int samplingLevel) throws IOException
    {
        synchronized (tidy.global)
        {
            assert openReason != OpenReason.EARLY;
    ...
    private static final class InstanceTidier implements Tidy
    {
        ...
        public void tidy()
        {
            ...
            final TableStore cfs = Schema.instance.getColumnFamilyStoreInstance(tableId);
