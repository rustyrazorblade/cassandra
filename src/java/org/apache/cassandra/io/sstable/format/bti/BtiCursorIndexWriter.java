...
public class BtiCursorIndexWriter extends CursorIndexWriter
{
                             ...
                             ClusteringDescriptor lastName) throws IOException
    {
        ...
        // lastName goes unused: this format copies both block boundaries into its own reusable
        // descriptors at rowWritten time, so lastClustering already holds the same value
