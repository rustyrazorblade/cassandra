...
public class RangeAwareSSTableWriter implements SSTableMultiWriter
{
    ...
    public RangeAwareSSTableWriter(Table cfs, long estimatedKeys, long repairedAt, UUID pendingRepair, SSTableFormat.Type format, int sstableLevel, long totalSize, LifecycleTransaction txn, SerializationHeader header) throws IOException
    {
