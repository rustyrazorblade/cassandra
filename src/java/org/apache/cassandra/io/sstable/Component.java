...
public class Component
{
    ...
    public final static class Type
    {
         ...
         * So, e.g. given we have `TOC@SSTableFormat`, and `BtiFormat` tries to define `TOC@BtiFormat`, we should
         * forbid that; but, given we have `INDEX@BtiFormat`, we should allow a custom format to define `INDEX@CustomFormat`
         * as those types are be distinguishable via format type.
         *
