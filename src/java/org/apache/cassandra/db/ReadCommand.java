...
public abstract class ReadCommand extends MonitorableImpl implements ReadQuery
{
    ...
    protected abstract UnfilteredPartitionIterator queryStorage(TableStore cfs, ReadExecutionController executionController);
    ...
    public Index getIndex(TableStore cfs)
    {
        return null != index
    ...
    static IndexMetadata findIndex(TableMetadata table, RowFilter rowFilter)
    {
        ...
        TableStore cfs = Keyspace.openAndGetStore(table);
    ...
    public UnfilteredPartitionIterator executeLocally(ReadExecutionController executionController)
    {
        ...
        TableStore cfs = Keyspace.openAndGetStore(metadata());
    ...
    protected UnfilteredPartitionIterator withoutPurgeableTombstones(UnfilteredPartitionIterator iterator, TableStore cfs)
    {
