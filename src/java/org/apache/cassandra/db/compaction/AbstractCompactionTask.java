...
public abstract class AbstractCompactionTask extends WrappedRunnable
{
     ...
     */
    public AbstractCompactionTask(TableStore cfs, LifecycleTransaction transaction)
    {
        this.cfs = cfs;
    ...
    public abstract CompactionAwareWriter getCompactionAwareWriter(TableStore cfs, Directories directories, LifecycleTransaction txn, Set<SSTableReader> nonExpiredSSTables);
