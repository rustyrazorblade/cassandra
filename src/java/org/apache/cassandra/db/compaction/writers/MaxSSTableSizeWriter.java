...
public class MaxSSTableSizeWriter extends CompactionAwareWriter
{
    ...
    public MaxSSTableSizeWriter(Table cfs,
     ...
     */
    private static long getTotalWriteSize(Iterable<SSTableReader> nonExpiredSSTables, long estimatedTotalKeys, Table cfs, OperationType compactionType)
    {
