...
class PendingRepairManager
{
    ...
    PendingRepairManager(TableStore cfs, CompactionParams params)
    {
        this.cfs = cfs;
        this.params = params;
    }
    ...
    class RepairFinishedCompactionTask extends AbstractCompactionTask
    {
        ...
        RepairFinishedCompactionTask(TableStore cfs, LifecycleTransaction transaction, UUID sessionID, long repairedAt)
        {
        ...
        public CompactionAwareWriter getCompactionAwareWriter(TableStore cfs, Directories directories, LifecycleTransaction txn, Set<SSTableReader> nonExpiredSSTables)
        {
