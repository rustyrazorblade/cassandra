...
public class Verifier implements Closeable
{
    ...
    public Verifier(Table cfs, SSTableReader sstable, boolean isOffline, Options options)
    {
        this(cfs, sstable, new OutputHandler.LogOutput(), isOffline, options);
    }

    public Verifier(Table cfs, SSTableReader sstable, OutputHandler outputHandler, boolean isOffline, Options options)
    {
        this.cfs = cfs;
    ...
    {
        public VerifyController(Table cfs)
        {
