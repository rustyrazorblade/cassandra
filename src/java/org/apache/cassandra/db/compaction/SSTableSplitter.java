...
public class SSTableSplitter 
{
    ...
    public SSTableSplitter(TableStore cfs, LifecycleTransaction transaction, int sstableSizeInMB)
    {
    ...
    public static class SplittingCompactionTask extends CompactionTask
    {
        ...
        public SplittingCompactionTask(TableStore cfs, LifecycleTransaction transaction, int sstableSizeInMB)
        {
    ...
    {
        public SplitController(TableStore cfs)
        {
