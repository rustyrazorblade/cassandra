...
public class SizeTieredCompactionStrategy extends AbstractCompactionStrategy
{
    ...
    public SizeTieredCompactionStrategy(TableStore cfs, Map<String, String> options)
    {
        super(cfs, options);
    ...
    public static int getEstimatedCompactionsByTasks(TableStore cfs, List<List<SSTableReader>> tasks)
    {
        int n = 0;
    ...
    {
        public SplittingCompactionTask(TableStore cfs, LifecycleTransaction txn, int gcBefore)
        {
