...
public class ViewBuilderTask extends CompactionInfo.Holder implements Callable<Long>
{
    ...
    ViewBuilderTask(Table baseCfs, View view, Range<Token> range, Token lastToken, long keysBuilt)
    {
    ...
    public Long call()
    {
        ...
        try (Table.RefViewFragment viewFragment = baseCfs.selectAndReference(function);
