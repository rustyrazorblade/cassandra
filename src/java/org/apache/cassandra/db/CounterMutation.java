...
public class CounterMutation implements IMutation
{
    ...
    {
        TableStore cfs = Keyspace.open(getKeyspaceName()).getColumnFamilyStore(changes.metadata().id);
    ...
    private void updateWithCurrentValue(PartitionUpdate.CounterMark mark, ClockAndCount currentValue, TableStore cfs)
    {
    ...
    private void updateWithCurrentValuesFromCache(List<PartitionUpdate.CounterMark> marks, TableStore cfs)
    {
    ...
    private void updateWithCurrentValuesFromCFS(List<PartitionUpdate.CounterMark> marks, TableStore cfs)
    {
    ...
    private int compare(Clustering c1, Clustering c2, TableStore cfs)
    {
    ...
    private void updateForRow(PeekingIterator<PartitionUpdate.CounterMark> markIter, Row row, TableStore cfs)
    {
        int cmp = 0;
