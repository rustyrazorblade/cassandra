...
public final class SystemKeyspace
{
    ...
    public static synchronized void saveTruncationRecord(Table cfs, long truncatedAt, CommitLogPosition position)
    {
    ...
    private static Map<UUID, ByteBuffer> truncationAsMapEntry(Table cfs, long truncatedAt, CommitLogPosition position)
    {
    ...
    */
    ...
    public static void checkHealth() throws ConfigurationException
    {
        ...
        Table cfs = keyspace.getColumnFamilyStore(LOCAL);
    ...
    {
        Table availableRanges = Keyspace.open(SchemaConstants.SYSTEM_KEYSPACE_NAME).getColumnFamilyStore(AVAILABLE_RANGES);
    ...
    {
        Table availableRanges = Keyspace.open(SchemaConstants.SYSTEM_KEYSPACE_NAME).getColumnFamilyStore(PREPARED_STATEMENTS);
        availableRanges.truncateBlocking();
    }
